...
declare namespace Cypress {
  interface Chainable {
     ...
     *
     * @example cy.updateNote('Learn Cypress', 'Get more knowledge into Cypress') // Edits the description of note with the text 'Learn Cypress' to 'Get more knowledge into Cypress'
     * @example cy.updateNote('Learn Cypress', 'Get more knowledge into Cypress', true) // Edits the description of note with the text 'Learn Cypress' to 'Get more knowledge into Cypress' and attaches the `example.json` file to it
     */
     updateNote(note: string, newValue: string, attachFile?: boolean): Cypress.Chainable<undefined>
